...
--
-- Servidor: localhost
-- Tiempo de generación: 05-06-2017 a las 10:10:36
...
--
CREATE DATABASE IF NOT EXISTS `vidaSostenible` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `vidaSostenible`;
...
(1, 73, 13, 4, 3, 1, 2, 2, 5, 3),
(2, 73, 15, 4, 1, 2, 1, 2, 5, 2),
(3, 73, 13, 2, 2, 2, 3, 5, 2, 4),
(4, 73, 9, 2, 2, 2, 4, 5, 2, 3),
(5, 73, 15, 4, 1, 3, 4, 5, 2, 2),
(6, 73, 12, 5, 1, 2, 2, 2, 5, 1),
(7, 73, 5, 3, 1, 1, 2, 3, 3, 4),
